...
screen.connect_signal("request::desktop_decoration", function(s)
    ...
    awful.tag({ "1", "2", "3", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[myflag])
    myflag = myflag + 1
...
--awful.key({ modkey },            "r",     function () awful.util.spawn(terminal.." -e htop ") end,
    awful.key({ modkey },            "r",     function () awful.util.spawn("roficustom") end,
